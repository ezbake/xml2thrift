...
public class TStructDescriptor {
  ...
  public static class Field {
    ...
    @SuppressWarnings("unchecked")
    private Field(TFieldIdEnum fieldIdEnum, FieldMetaData fieldMetaData, String fieldName, Type genericType, FieldValueMetaData field) {
      ...
      if (!simpleField && field instanceof ListMetaData) {
        listElemField = new Field(null, null, fieldName + "_list_elem", firstTypeArg, ((ListMetaData)field).elemMetaData);
      } else {
        listElemField = null;
      }

      if (!simpleField && field instanceof MapMetaData) {
        mapKeyField = new Field(null, null, fieldName + "_map_key", firstTypeArg, ((MapMetaData)field).keyMetaData);
        mapValueField = new Field(null, null, fieldName + "_map_value", secondTypeArg, ((MapMetaData)field).valueMetaData);
      } else {
        mapKeyField = null;
        mapValueField = null;
      }
      ...
      if (!simpleField && field instanceof SetMetaData) {
        setElemField = new Field(null, null, fieldName + "_set_elem", firstTypeArg, ((SetMetaData)field).elemMetaData);
      } else {
        setElemField = null;
      }
      ...
      isBuffer = field.type == TType.STRING && !genericType.equals(String.class);
    }
